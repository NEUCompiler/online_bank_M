...
<html>
  ...
  <body>
    <form name="loginForm"
							action="<%=path%>/SystemParrateAction/sysParrate_depositupdateRP.action"
							method="post">
  <div id="aheadtime">
							 ...
							 <div id="amount">
								<span class="item">新&nbsp;&nbsp;&nbsp;&nbsp;税&nbsp;&nbsp;&nbsp;率:</span> <span
									class="input"><input type="text" name="interest"
									class="form-input"></span>
							</div>
							<div id="amount">
								<span class="item">新&nbsp;&nbsp;&nbsp;&nbsp;时&nbsp;&nbsp;&nbsp;间:</span> <span
									class="input"><input type="text" name="time"
									class="form-input"></span>
							</div>
							<div id="button-group">
