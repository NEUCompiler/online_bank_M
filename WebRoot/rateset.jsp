...
.button {
  ...
  <head>
    ...
    <title>My JSP 'rateset.jsp' starting page</title>
  ...
  <body>
   <div id="buttonGroup">
			<div class="button"
				...
				<a href="<%=path%>/SystemParrateAction/sysParrate_loanshow.action">贷款利率</a>
			</div>
			<div class="button"
				onmouseout="this.style.backgroundColor='';this.style.fontWeight='normal'"
				onmouseover="this.style.backgroundColor='#77D1F6';this.style.fontWeight='bold'">
				<a href="<%=path%>/SystemParrateAction/sysParrate_depositshow.action">存款利率</a>
			</div>
		</div><br>
  </body>
</html>
